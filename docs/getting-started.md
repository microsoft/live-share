...
| Owner: Connecting  | | ![VS Code after sign in status bar item](media/vscode-status-connecting.png)| Connecting to service and starting new collaboration session. |
