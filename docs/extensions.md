...
|-------|----------|--------|-----|
| Grammars / Syntax highlighting | [Vetur](https://marketplace.visualstudio.com/items?itemName=octref.vetur), [DotEnv](https://marketplace.visualstudio.com/items?itemName=mikestead.dotenv) | ❌ | ✅ |
