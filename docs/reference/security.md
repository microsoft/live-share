...
> To enable: In VS Code, add *"liveshare.features":"experimental"* to *settings.json*. In Visual Studio, set *Tools > Options > Features* to *Experimental*. Be aware that these features are still in flight and subject to change.
